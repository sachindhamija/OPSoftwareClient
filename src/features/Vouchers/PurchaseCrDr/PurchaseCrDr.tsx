...
const PurchaseCrDr = () => {
  ...
  return (
    <>
      <CommonCard header="Purchase CR/DR" size="100%" style={{ position: 'relative' }}>
        <Form>
          <Row className="mb-3">
            <Col md={2}>
        ...
        <div style={{overflowY: "auto", paddingBottom:'105px' }}>
        ...
        {/* Footer Table */}
        <div className="form-footer" style={{ position: 'absolute' , bottom:'10px', right:'10px', paddingTop:'10px',backgroundColor:'white' }}>
          <div className="remarks-and-actions">
            {/* Add any remarks or actions here */}
          </div>
          <div className="bill-summary" style={{minWidth: '300px'}}>
            <table>
              <thead>
                <tr>
                  <th className="custom-col-billBook">Sub Total</th>
                  <th className="custom-col-reduced">Value</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="custom-col-billBook">Total</td>
                  <td>{getTotal("amount")}</td>
                </tr>
                <tr>
                  <td className="custom-col-billBook">Paid</td>
                  <td>{getTotal("received")}</td>
                </tr>
                <tr>
                  <td className="custom-col-billBook">Current Balance</td>
