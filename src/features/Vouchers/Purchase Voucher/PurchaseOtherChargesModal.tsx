...
import { OtherChargesDto } from './PurchasesalePurchaseVoucherDto';
...
interface PurchaseOtherChargesModalProps {
  show: boolean;
  onHide: () => void;
...
const PurchaseOtherChargesModal: React.FC<PurchaseOtherChargesModalProps> = ({ show, onHide, onSave, initialData, voucherDate,summaryAmount }) => {
...
export default PurchaseOtherChargesModal;
