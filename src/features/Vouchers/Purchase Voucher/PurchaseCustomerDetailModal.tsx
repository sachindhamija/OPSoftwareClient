...
import { CustomerDetailDto } from './PurchasesalePurchaseVoucherDto';


interface PurchaseCustomerDetailModalProps {
    show: boolean;
    onHide: () => void;
...
const PurchaseCustomerDetailModal: React.FC<PurchaseCustomerDetailModalProps> = ({ show, onHide, onSave, initialData }) => {
...
export default PurchaseCustomerDetailModal;
