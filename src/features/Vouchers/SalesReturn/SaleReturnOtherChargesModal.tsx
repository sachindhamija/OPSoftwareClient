...
import { OtherChargesDto } from './saleReturnPurchaseVoucherDto';
...
interface SaleReturnOtherChargesModalProps {
  show: boolean;
  onHide: () => void;
...
const SaleReturnOtherChargesModal: React.FC<SaleReturnOtherChargesModalProps> = ({ show, onHide, onSave, initialData, voucherDate,summaryAmount }) => {
...
export default SaleReturnOtherChargesModal;
