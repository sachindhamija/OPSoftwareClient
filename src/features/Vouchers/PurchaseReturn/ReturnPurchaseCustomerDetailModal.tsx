...
import { CustomerDetailDto } from './PurchaseReturnsalePurchaseVoucherDto';


interface ReturnPurchaseCustomerDetailModalProps {
    show: boolean;
    onHide: () => void;
...
const ReturnPurchaseCustomerDetailModal: React.FC<ReturnPurchaseCustomerDetailModalProps> = ({ show, onHide, onSave, initialData }) => {
...
export default ReturnPurchaseCustomerDetailModal;
