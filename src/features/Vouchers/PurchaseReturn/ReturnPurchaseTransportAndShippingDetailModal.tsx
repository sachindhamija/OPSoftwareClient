...
import { TransportDetailDto } from './PurchaseReturnsalePurchaseVoucherDto';
...
const ReturnPurchaseTransportAndShippingDetailModal: React.FC<TransportDetailsModalProps> = ({ show,
    onHide,
    onSave,
    initialData }) => {
...
export default ReturnPurchaseTransportAndShippingDetailModal;
