      ...
      { path: "not-found", element: <NotFound /> },
      {
        ...
        children: [
          ...
          { path: "item/edit/:itemID", element: <ItemForm /> },
          {
            ...
            element: (
              <PaymentAndReceiptForm voucherType={VoucherTypeEnum.Payment} />
            ),
          },
          {
            path: "Voucher/Receipt",
            element: (
              <PaymentAndReceiptForm voucherType={VoucherTypeEnum.Receipt} />
            ),
          },
          ...
          },
          {
            path: "Voucher/Sale",
            element: (
              <SalePurchaseForm voucherType={VoucherTypeEnum.ItemSale} />
            ),
          },
          {
            path: "Voucher/Purchase",
            element: (
              <SalePurchaseForm voucherType={VoucherTypeEnum.ItemPurchase} />
            ),
          },
          {
            path: "Voucher/SalesReturn",
            element: (
              <SalePurchaseForm voucherType={VoucherTypeEnum.SalesReturn} />
            ),
          },
          {
            path: "Voucher/PurchaseReturn",
            element: (
              <SalePurchaseForm voucherType={VoucherTypeEnum.PurchaseReturn} />
            ),
          },
          {
            path: "Voucher/DebitNote",
            element: (
              <SalePurchaseForm voucherType={VoucherTypeEnum.DebitNote} />
            ),
          },
          {
            path: "Voucher/CreditNote",
            element: (
              <SalePurchaseForm voucherType={VoucherTypeEnum.CreditNote} />
            ),
          },
          ...
          {
            path: "additional-fields-setting",
            element: <AdditionalFieldSetting />,
          },
          { path: "IJForm", element: <IJForm /> },
          { path: "mandi", element: <MandiForm /> },
          {
            path: "commissionagent-item",
            element: <CommissionAgentItemForm />,
          },
