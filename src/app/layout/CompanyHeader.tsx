...
function CompanyHeader() {
	...
	async function getAllFinancialYears() {
		try {
			const response = await agent.FinancialYear.getAllFinancialYears(
				accessId
			);
			...
			<Nav className="flex-grow-1 align-items-center">
				...
				<Dropdown as="div" className="dropdown-on-hover">
					...
					>
						...
						<Dropdown.Divider />
						<Dropdown.Item as={Link} to={'/Voucher/PurchaseVoucher'}>
							Purchase Voucher
						</Dropdown.Item>
						<Dropdown.Divider />
						...
						<Dropdown as="div" className="dropdown-on-hover">
							...
							<Dropdown.Menu className="custom-dropdown-menu">
								...
								<div className="d-flex align-items-center justify-content-center ">
									<Dropdown.Item
										onClick={() => setShowFYYearModal(true)}
									>
